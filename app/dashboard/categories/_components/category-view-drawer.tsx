...
export function CategoryViewDrawer({ item, children }: CategoryViewDrawerProps) {
  ...
  return (
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent className={isMobile ? "" : "sm:max-w-md ml-auto h-full"}>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm scrollbar-hide py-4 flex-1">
          {item.featured_image && (
